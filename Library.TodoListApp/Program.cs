...
namespace Library.TodoListApp
{
    public class Program {
            ...
            for (string input = ""; input != MenuCommand.EXIT;)
            {
                ...
                switch (inputTrimmed)
                {
                    ...
                    case MenuCommand.EXIT:
                        JsonData.Save(new ObservableCollection<TodoItem>(TaskManager.Items));
                        break;
                    default:
        ...
        private static void Edit()
        {
            ...
            if (TaskManager.FindItem(id) == default(TodoItem))
            {
            ...
            var description = Console.ReadLine();
            if (TaskManager.FindItem(id) is TodoAppointment a)
            {
